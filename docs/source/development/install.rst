...
.. note::
   ...
   Ответы на вопросы, решения возможных проблем и обсуждение альтернативных способов установки можно найти на форуме игры `в соответствующей теме <https://the-tale.org/forum/threads/8025>`_.
